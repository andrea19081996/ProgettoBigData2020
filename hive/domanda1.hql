...
LOAD DATA LOCAL INPATH '/home/davide/Documenti/progettoBigData/dataset/historical_stock_prices.csv' OVERWRITE INTO TABLE historical_stock_prices_temp;
...
CREATE VIEW with_chiusura_iniziale AS
...
CREATE VIEW with_chiusura_finale AS
